...
# the first arg
hexdump -ve '1/1 "%02x"' build/LPCoin/package-metadata.bcs
# the second arg
hexdump -ve '1/1 "%02x"' build/LPCoin/bytecode_modules/LPCoinV1.mv
# This command is to publish LPCoin contract, using ResourceAccountDeployer address. You should replace two args with the above hex
aptos move run --function-id 0x16fe2df00ea7dde4a63409201f7f4e536bde7bb7335526a35d05111e68aa322c::lp_resource_account::initialize_lp_account \
